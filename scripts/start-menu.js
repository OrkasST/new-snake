let startBtn = {
    ...
    x: 50,
    y: 50,
    image: start_game_button_image
}

let inGame = false;

function displayMenu(lang) {
    if (lang === 'en') ctx.drawImage(startBtn.image, 0,0, 200, 70, startBtn.x, startBtn.y, 200, 70);
    if (lang === 'ru') ctx.drawImage(startBtn.image, 0,70, 200, 70, startBtn.x, startBtn.y, 200, 70);
    // //box
    // ctx.beginPath();
